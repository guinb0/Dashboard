...
def inicializar_dados():
    ...
    if 'riscos' not in st.session_state:
        ...
        justificativas_modalidades_detalhadas = {
            ...
            'Indisponibilidade de imóveis públicos p/ implantação ou dação em permuta': {
                'Permuta por imóvel já construído': 'Necessidade de imóveis com valor compatível.',
                'Permuta por edificação a construir (terreno terceiros)': 'Necessidade de imóveis com valor compatível.',
                'Permuta por obra (terreno da União)': 'Necessidade de imóveis com valor compatível.',
                'Build to Suit (terreno da União)': 'Parte pode ser paga via custeio (locação).',
                'Contratação com dação em pagamento': 'Parte pode ser paga via custeio (locação).',
                'Obra pública convencional': 'Só precisa de imóvel para implantação.'
            },
            'Condições de mercado desfavoráveis': {
                'Permuta por imóvel já construído': 'Pouco esforço financeiro, mas mercado restrito; divergência na avaliação.',
                'Permuta por edificação a construir (terreno terceiros)': 'Exigência de alta capacidade financeira (pagamento só após entrega).',
                'Permuta por obra (terreno da União)': 'Exigência de alta capacidade financeira (pagamento só após entrega).',
                'Build to Suit (terreno da União)': 'Exigência de alta capacidade financeira (parte em imóvel e parte em locação; operação longa).',
                'Contratação com dação em pagamento': 'Pagamentos e repasse durante execução; mercado amplo.',
                'Obra pública convencional': 'Pagamentos e repasse durante execução; mercado amplo.'
            },
            'Abandono da obra pela empresa': {
                'Permuta por imóvel já construído': 'Imóvel pronto (operação rápida).',
                'Permuta por edificação a construir (terreno terceiros)': 'Empresa pode romper contrato se mercado for vantajoso.',
                ...
                'Contratação com dação em pagamento': 'Perda do investimento (menor, parte já paga).',
                'Obra pública convencional': 'Perda do investimento (menor, parte já paga).'
            },
            'Baixa rentabilização do estoque de imóveis': {
                'Permuta por imóvel já construído': 'Pagamento por terreno privado, sujeição ao padrão de mercado.',
                'Permuta por edificação a construir (terreno terceiros)': 'Pagamento por terreno privado.',
                'Permuta por obra (terreno da União)': 'Terreno próprio, padrão definido pela Administração.',
                'Build to Suit (terreno da União)': 'Pagamento de locação acima do mercado, padrão de mercado em ocupação parcial.',
                'Contratação com dação em pagamento': 'Terreno próprio, padrão definido, desfazimento de imóveis ociosos.',
                'Obra pública convencional': 'Terreno próprio, padrão definido, sem desfazimento de imóveis ociosos.'
            },
            'Dotação orçamentária insuficiente': {
                'Permuta por imóvel já construído': 'Não precisa orçamento.',
                ...
                'Build to Suit (terreno da União)': 'Precisa orçamento para locação e projetos.',
                'Contratação com dação em pagamento': 'Precisa orçamento para diferença entre contrato e imóveis repassados.',
                'Obra pública convencional': 'Construção custeada com OGU.'
            },
            'Questionamento jurídico': {
                'Permuta por imóvel já construído': 'Histórico de recomendações; justificação em caso de inexigibilidade.',
                'Permuta por edificação a construir (terreno terceiros)': 'Histórico de recomendações; justificação em caso de inexigibilidade.',
                'Permuta por obra (terreno da União)': 'Histórico de recomendações; justificação em caso de inexigibilidade.',
                'Build to Suit (terreno da União)': 'Histórico de recomendações; justificação em caso de inexigibilidade.',
                'Contratação com dação em pagamento': 'Modelagem inovadora; mitigável via TCU/AGU/SOF; concorrência.',
                'Obra pública convencional': 'Obra pública.'
            },
            'Baixa qualidade dos serviços entregues': {
                'Permuta por imóvel já construído': 'Sem acompanhamento do processo construtivo.',
                'Permuta por edificação a construir (terreno terceiros)': 'Sem acompanhamento do processo construtivo.',
                'Permuta por obra (terreno da União)': 'Acompanhamento limitado.',
                'Build to Suit (terreno da União)': 'Acompanhamento limitado.',
...
def main():
    ...
    # Se a URL contém o parâmetro 'login=true', exibe o formulário de login
                ...
                <div class="hero">
                    <div class="hero-container">
                        ...
                        <div class="hero-buttons">
                            <button id="access-btn" class="btn-primary" onclick="window.location.href = '?login=true'">
                                <i class="fas fa-sign-in-alt"></i>
                                Acessar Sistema
                            </button>
                            <a href="#" class="btn-secondary" onclick="window.location.href = '#features'">
                                Ver Recursos
                            </a>
                        </div>
                    </div>
